...
var (
	...
	accountAddressWitness             = "TFFLWM7tmKiwGtbh2mcz2rBssoFjHjSShG"
...
func TestDelegate(t *testing.T) {
	t.Skip() // Only in testnet nile
	tx, err := conn.DelegateResource(testnetNileAddressExample, testnetNileAddressDelegateExample, core.ResourceCode_BANDWIDTH, 1000000, false, 28800)
